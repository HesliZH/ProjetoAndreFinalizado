<?php
   ...
   if($_GET[exc]){
      ...
      $db->grava("insert into reclamacao(aluno, setor, professor, texto, statusoperacao) values ($_SESSION[codigo], $_POST[setor], $_POST[professor], '$_POST[TextoReclamacao]', 1)","Registro incluÃ­do com sucesso!","Erro ao inserir o registro","index.php");
   }   
   foot();
?>